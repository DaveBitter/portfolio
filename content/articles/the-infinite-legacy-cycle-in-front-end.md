...
tags:
  - front-end
intro: >-
  As a front-end developer and consultant, It seems like many of the existing
  projects I join have the same issues. Generally, within the first week, you
  hear one of the following quotes:
teaserCopy: >-
  Projects often become legacy in an incredibly short time. I have spoken to
