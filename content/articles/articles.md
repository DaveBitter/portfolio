...
items:
  ...
  - body: >-
      ...
      [GraphQL]([https://graphql.org/](https://graphql.org/)) gets a lot of traction and notice, which is right, but setting it up for a simple blog could be a bit too much. Next.js provides a simple [RESTful]([https://restfulapi.net/](https://restfulapi.net/)) API for your front-end to consume. No fancy techniques here, but an easy-to-use API.
