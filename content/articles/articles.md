...
items:
  - type: articles
    body: >-
      ...
      * **Cost** - last but not least, you dramatically cut down costs by just hosting a (static) website and using the user’s machine for the machine
      learning part
    ...
    teaserCopy: >-
      TensorFlow.js is an incredibly powerful JavaScript library for training and deploying machine learning models in the browser and Node. js. Let’s explore this library by building a teachable machine!
    teaserImage: /img/articles/on-the-fly-machine-learning-in-the-browser-with-tensor-flow-js-hero.webp
    title: >-
  ...
  - type: articles
    body: >-
      ...
      ![A form gets handled appropriately by a React.js Server Action](/img/articles/progressively-enhance-handling-your-forms-with-react-js-server-actions-server-side-form.gif)
    ...
    slug: progressively-enhance-handling-your-forms-with-react-js-server-actions
    tags:
      - front-end
      - react-js
      - next-js
    ...
    teaserCopy: >-
      A large part of adding interactivity to your applications is through forms. Single Page Applications SPAs have not always handled this part the best. Let’s have a look at how we can use React.js Server Actions to handle your forms progressively enhanced.
    teaserImage: /img/articles/progressively-enhance-handling-your-forms-with-react-js-server-actions-hero.png
    title: >-
  ...
  - type: articles
    body: >-
      ...
      ![A person using the Apple Vision Pro showing three transparent screens around them](/img/articles/your-user-does-not-prefer-your-design-apple-vision-pro-glass-ui.webp)
    ...
    slug: your-user-does-not-prefer-your-design
    tags:
      - front-end
      - css
    intro: >-
