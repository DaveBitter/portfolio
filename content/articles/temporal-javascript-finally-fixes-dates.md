...
slug: temporal-javascript-finally-fixes-dates
tags:
  - front-end
  - javascript
intro: >-
  Temporal shipped in Chrome 144 and hit TC39 Stage 4. Immutable types, real
  timezone support, and no more zero-indexed months. Here's why it finally
  replaces Date.
teaserCopy: >-
  Temporal shipped in Chrome 144 and hit TC39 Stage 4. Immutable types, real
  timezone support, and no more zero-indexed months. Here's why it finally
  replaces Date.
teaserImage: /img/articles/temporal-javascript-finally-fixes-dates-hero.webp
